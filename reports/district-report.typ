...
#let header = {
  block(width: 100%, height: 60pt, {
    ...
    block(width: 100% - 60pt, inset: (left: 15pt), [
      ...
      #linebreak()
      #text(size: 8pt, fill: rgb(100, 100, 100))[#data.agent.phone]
      #h(1em)
      #text(size: 8pt, fill: rgb(100, 100, 100))[#data.agent.email]
    ])
  })
...
#grid(
  ...
  block(fill: rgb(245, 248, 252), inset: 12pt, radius: 4pt, [
    ...
    #linebreak()
    #text(size: 16pt, weight: "bold", fill: black)[#format_num(metrics.rent_m2, decimals: 2) €/m²]
  ]),

  block(fill: rgb(245, 248, 252), inset: 12pt, radius: 4pt, [
    #text(size: 8pt, weight: "bold", fill: accent)[POPULATION]
    #linebreak()
    #text(size: 16pt, weight: "bold", fill: black)[#format_num(metrics.population, decimals: 0)]
    #v(0.2em)
...
#grid(
  ...
  block(fill: rgb(250, 250, 250), inset: 10pt, radius: 4pt, [
    ...
    #linebreak()
    #text(size: 12pt, weight: "bold", fill: black)[#format_num(metrics.vacancy_rate, decimals: 1)%]
  ]),

  block(fill: rgb(250, 250, 250), inset: 10pt, radius: 4pt, [
    #text(size: 7pt, fill: rgb(80, 80, 80), weight: "bold")[HOSPITALITY STOCK]
    #linebreak()
    #text(size: 12pt, weight: "bold", fill: black)[#format_num(metrics.horeca_stock, decimals: 0)]
  ]),

  block(fill: rgb(250, 250, 250), inset: 10pt, radius: 4pt, [
    #text(size: 7pt, fill: rgb(80, 80, 80), weight: "bold")[TOURIST LETS]
    #linebreak()
    #text(size: 12pt, weight: "bold", fill: black)[#format_num(metrics.vut_licensed, decimals: 0)]
  ]),
)
...
#block(fill: rgb(250, 250, 250), inset: 10pt, radius: 4pt, [
  ...
  #linebreak()
  #text(size: 12pt, weight: "bold", fill: black)[#format_num(metrics.licences_granted, decimals: 0) licences]
])
